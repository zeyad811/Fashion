...
const translations = {
  ar: {
    ...
    "offer-badge-1": "خصم 50%",
    "offer-1-name": "طقم رياضي كامل",
    "offer-1-desc": "طقم رياضي مريح مناسب للتدريب والخروج اليومي",
    "offer-badge-2": "عرض 2 بسعر 1",
    "offer-2-name": "تيشيرت بولو كلاسيك",
    "offer-2-desc": "اشترِ 2 واحصل على الثالث مجاناً",
    "offer-badge-3": "خصم 30%",
    "offer-3-name": "جاكيت شتوي مبطن",
    "offer-3-desc": "جاكيت دافئ بأجود خامات الشتاء",
    "offer-timer": "⏰ ينتهي خلال 3 أيام",
  ...
  en: {
    ...
    "offer-badge-1": "50% OFF",
    "offer-1-name": "Full Tracksuit Set",
    "offer-1-desc": "Comfortable tracksuit perfect for training and daily wear",
    "offer-badge-2": "Buy 2 Get 1 Free",
    "offer-2-name": "Classic Polo T-Shirt",
    "offer-2-desc": "Buy 2 and get the third one free",
    "offer-badge-3": "30% OFF",
    "offer-3-name": "Padded Winter Jacket",
    "offer-3-desc": "Warm jacket with premium winter materials",
    "offer-timer": "⏰ Ends in 3 days",
